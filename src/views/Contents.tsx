  ...
  return (
    <div className='grid gap-4'>
      ...
      <ContentBlock
        ...
        <div className='w-1/2 mb-8'>
          <h3 className='text-5xl font-bold mb-4 leading-tight'>
            Что включает в себя <br /> система?
          </h3>
        </div>
        <div className='grid grid-cols-2 gap-4 px-8 mb-16'>
          <div className='flex items-center justify-center bg-background px-8 py-10 rounded-[48px] rounded-br-md mb-28 text-2xl font-semibold text-center relative'>
            Адаптивный тест на определение уровня владения английским языком в соответствии с
            Общеевропейской шкалой (CEFR) от А1 до С2
            <Image
          ...
          <div className='relative flex items-center justify-center bg-background px-8 py-10 rounded-[48px] rounded-tl-md mt-28 text-2xl font-semibold text-center'>
            ...
            <SecondContentBlockIll1 className='absolute -top-[109%] left-0' />
          </div>
        </div>
      </ContentBlock>
      {/* Third content block */}
        ...
        <div className='grid grid-cols-3 gap-2'>
          ...
          <PatternCard
            ...
            <p className='text-black text-xl'>
              ...
              в конце академическолго года или по окончании
            </p>
          </PatternCard>
          <PatternCard
            icon={
        ...
        <div className=' grid grid-cols-2 gap-4 mb-16'>
          <div className='w-full min-h-44 px-8 py-6 bg-background rounded-[48px] relative'>
            ...
            <p className='text-xl font-medium'>
              При распределении первокурсников на программы и для определения уровня языковых
              компетенций выпускников бакалавриата, магистратуры и аспирантуры.
            </p>
          </div>
          <div className='w-full min-h-44 px-8 py-6 bg-background rounded-[48px] relative'>
            ...
            <p className='text-xl font-medium'>
              ...
              работающих в различных сферах иностранной профессиональной деятельности.
            </p>
          </div>
        </div>
      </ContentBlock>
